...
public class PedropathingTeleop {
    ...
    public class ExampleAprilTagUsage extends OpMode {
        ...
        private Pose getRobotPoseFromCamera() {
            ...
            return new Pose(result.getBotpose().getPosition().x, result.getBotpose().getPosition().y, result.getBotpose().getOrientation().getYaw(AngleUnit.RADIANS), FTCCoordinates.INSTANCE).getAsCoordinateSystem(PedroCoordinates.INSTANCE);
        }
    }
}
