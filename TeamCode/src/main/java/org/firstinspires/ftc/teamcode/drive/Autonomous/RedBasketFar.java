    ...
    public void buildPaths(){
        ...
        Path6 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(87.545, 11.575),
                                new Pose(77.080, 35.562),
                                new Pose(133.052, 36.089)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        switch (pathState){
            ...
            case PATH5:
                if(!follower.isBusy()){
                    ...
                    if(!runOnce){
                        follower.followPath(Path5,0.65,false);
                        runOnce = true;
                    }
            ...
            case PATH8:
                if(!follower.isBusy()){
                    follower.followPath(Path8,0.6,false);
