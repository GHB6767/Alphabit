...
public class VarStorage {
    ...
    public static double max_leftturret_position = 1;
    public static double max_rightturret_position = 1;
    public static double max_angleturret_position = 0.2;
    ...
    public static double marginThreshold = 7.0;
    public static double turretServoPosToDegree = 1.0/300.0;
    public static double max_TurretAngle = 0.2;
    public static double min_TurretAngle = 0.9;
