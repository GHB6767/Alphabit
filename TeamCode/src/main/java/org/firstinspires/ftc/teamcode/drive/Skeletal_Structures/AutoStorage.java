...
public class AutoStorage {
    ...
    public static double RB_mainShooting_X = -12.0;
    public static double RB_mainShooting_Y = 15.0;

    public static double RB_startPickupMiddlePattern_X = 12.0;
    ...
    // BLUE BASKET
    public static double BB_mainShooting_X = -12.0;
    public static double BB_mainShooting_Y = -15.0;

    public static double BB_startPickupMiddlePattern_X = 12.0;
